...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.spmv_accel.autotvin_values.dat"
         "c.spmv_accel.autotvin_cols.dat"
         "c.spmv_accel.autotvin_rows.dat"
         "c.spmv_accel.autotvin_x.dat"
         "c.spmv_accel.autotvin_y.dat"
         "c.spmv_accel.autotvin_row_size.dat"
         "c.spmv_accel.autotvin_col_size.dat"
         "c.spmv_accel.autotvin_data_size.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.spmv_accel.autotvout_y.dat"
         "rtl.spmv_accel.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
