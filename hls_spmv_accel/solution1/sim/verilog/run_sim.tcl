...
if {[file isfile spmv_accel.autotvin.dat]} {
	file delete -force spmv_accel.autotvin.dat
}

if {[file isfile spmv_accel.autotvout.dat]} {
	file delete -force spmv_accel.autotvout.dat
}
