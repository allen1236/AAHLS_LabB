...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "spmv_accel.autotvin.dat"
	set constFileTvOut       "spmv_accel.autotvout.dat"
	set constFileHdlTvIn     "spmv_accel.autohdltvin.dat"
	set constFileHdlTvOut    "spmv_accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
