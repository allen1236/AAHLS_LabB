...
# 2 "<built-in>" 2
# 1 "spmv_base/spmv.cpp" 2
# 1 "spmv_base/spmv.h" 1
...
typedef float DTYPE;
__attribute__((sdx_kernel("spmv", 0))) void spmv(int rowPtr[NUM_ROWS+1], int columnIndex[NNZ],
    DTYPE values[NNZ], DTYPE y[SIZE], DTYPE x[SIZE]);
void spmv_s(int *rowPtr, int *columnIndex,
    DTYPE *values, DTYPE *y, DTYPE *x,
    int nRow);
# 2 "spmv_base/spmv.cpp" 2


__attribute__((sdx_kernel("spmv", 0))) void spmv(int rowPtr[NUM_ROWS+1], int columnIndex[NNZ],
  DTYPE values[NNZ], DTYPE y[SIZE], DTYPE x[SIZE])
{
#line 17 "D:/Documents/HLS/LabB/hls/spmv_base/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=spmv
# 6 "spmv_base/spmv.cpp"
